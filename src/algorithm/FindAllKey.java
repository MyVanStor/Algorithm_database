...
public class FindAllKey {
     ...
     */
    public static Set<Character> findAttributeStart(Set<Character> attributes, Map<Set<Character>, Set<Character>> functionalDependencies) {
     ...
     */
    public static Set<Character> findAttributeMiddle(Set<Character> attributes, Map<Set<Character>, Set<Character>> functionalDependencies) {
     ...
     * @return
     */
    public static Set<Set<Character>> findAllKeys(Set<Character> attributes, Map<Set<Character>, Set<Character>> functionalDependencies) {
    	...
    	if (attributeMiddles == null) {
    		...
    		for (Set<Character> set : subsets) {
				...
				if (AttributeClosure.findAttributeClosure(check, attributeStarts, functionalDependencies).containsAll(attributes)) {
					value.add(check);
				}
			}
    	}
