...
public class Demo {
	public static void main(String[] args) {
		System.out.println("Bao đóng: " + AttributeClosure.findAttributeClosure(Demo.createInputAttributes(),
				Demo.createAttributes(), Demo.createFunctionalDependencies()));
	}

	public static Multimap<Set<Character>, Set<Character>> createFunctionalDependencies() {
	 ...
	 */
	public static Set<Character> createAttributes() {
	 ...
	 * @return Tập thuộc tính của quan hệ
	 */
	public static Set<Character> createInputAttributes() {
